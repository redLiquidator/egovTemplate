...
shell> ant --projecthelp
    4. A newly created .jar file containing the JDBC driver will be
       ...
       instructions in Section Section, "Installing the Driver and
...
1.3. Connector/J Examples
   ...
   examples.
     * Example Section, "Obtaining a connection from the
       DriverManager"
     * Example Section, "Using java.sql.Statement to execute a SELECT
       query"
     ...
     * Example Section, "Setting CallableStatement input parameters"
     ...
     * Example Section, "Retrieving AUTO_INCREMENT column values in
       Updatable ResultSets"
     * Example Section, "Using a connection pool with a J2EE
       application server"
     * Example Section, "Example of transaction with retry logic"
...
Note
   ...
   driver attempt reconnectionsat the end of every transaction? false
   3.0.10
   ...
   Whichever condition is met first, 'queriesBeforeRetryMaster' or
   'secondsBeforeRetryMaster' will cause an attempt to be made to
   reconnect to the master. Time in seconds, defaults to 30 30 3.0.2
   ...
   rewriting of prepared statements for INSERT and REPLACE into
   multi-value inserts/replaces when executeBatch() is called? Notice
   that this has the potential for SQL injection if using plain
   java.sql.Statements and your code doesn't sanitize input
   correctly. Notice that if you don't specify stream lengths when
   ...
   supports warnings(MySQL 4.1.0 and newer)? true 3.1.2
   ...
   parameters reported as INOUT VARCHARs) instead of throwing an
   exception? false 5.0.3
...
1.5.1.3. Using CallableStatements to Execute Stored Procedures
   ...
   for more information on MySQL stored procedures.
...
1.5.2.4. Using Connector/J with Spring
   ...
   will be used. The first task is to setup a MySQL data source
...
<bean id="dao" class="code.Ex3DaoImpl">
   ...
   Now you need to setup the transaction configuration. The first
...
1.5.2.4.3. Connection Pooling
   ...
   small amount of overhead to create and setup the connection.
...
1.5.3. Common Problems and Solutions
   ...
   Questions
     * [1]1.5.3.1: When I try to connect to the database with MySQL
...
VendorError: 0
       ...
       command-line client.
     * [2]1.5.3.2: My application throws an SQLException 'No Suitable
       Driver'. Why is this happening?
     * [3]1.5.3.3: I'm trying to use MySQL Connector/J in an applet
...
SQLState: 08S01
VendorError: 0
     * [4]1.5.3.4: I have a servlet/application that works fine for a
       day, and then stops working overnight
     * [5]1.5.3.5: I'm trying to use JDBC-2.0 updatable result sets,
...
Warning
   ...
   There are three possible causes for this error:
     * The Connector/J driver is not in your CLASSPATH, see Section
       Section, "Connector/J Installation."
...
VendorError: 0
   ...
   1.5.3.4: I have a servlet/application that works fine for a day,
   ...
   use the "autoReconnect" parameter (see Section Section,
...
Note
   ...
   1.5.3.5: I'm trying to use JDBC-2.0 updatable result sets, and I
   ...
   1.5.3.6: I cannot connect to the MySQL server using Connector/J,
   ...
   (http://dev.mysql.com/doc/refman/5.0/en/can-not-connect-to-server.
   html).
...
1.6.2. How to Report Connector/J Bugs or Problems
   ...
   email to security_at_mysql.com (mailto:security_at_mysql.com).
...
1.6.3. Connector/J Change History
   ...
   main Changelog for MySQL. See MySQL Connector/J Change History
   (http://dev.mysql.com/doc/refman/5.1/en/cj-news.html).

References

   1. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-1
   2. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-2
   3. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-3
   4. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-4
   5. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-5
   6. file://localhost/home/mysqldoc/docs-build/mysqldoc/refman-common/connector-j-nolink.html#qandaitem-1-5-3-6
